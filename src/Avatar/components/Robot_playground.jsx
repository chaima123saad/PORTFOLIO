...
Command: npx gltfjsx@6.5.0 public/models/robot_playground.glb 
...
export function Robot(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null} position={[-1.2, 0.3, 2]}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 2]} scale={0.04}>
